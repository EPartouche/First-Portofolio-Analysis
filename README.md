...
### The following elements represent only an extract from the completed project. For a detailed view, open the attached ipynb document (Eliot_PARTOUCHE_Individual_Assignment.ipynb).
...
### Creation of two separate DataFrames
